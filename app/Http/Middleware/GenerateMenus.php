...
class GenerateMenus
{
    ...
    public function handle($request, Closure $next)
    {
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            // Submenu: Contact Page Management
            $dynamicContentMenu->add('<i class="nav-icon fas fa-file-contract"></i> '.__('Terms & Conditions'), [
            ...
            $dynamicContentMenu->add('<i class="nav-icon fas fa-user-shield"></i> '.__('Privacy & Policy'), [
                'route' => 'companyPolicy.policy',
                'class' => 'nav-item',
            ])->data([
                'order' => 7,
                'activematches' => 'admin*',
...
// Submenu: Solutions
$solutionMenu->add('<i class="nav-icon fas fa-users"></i> '.__('Solution'), [
    'route' => 'admin.solution-development.index',
    'class' => 'nav-item',
])->data([
    'order' => 16,
])->link->attr([
