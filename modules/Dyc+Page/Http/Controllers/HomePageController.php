 ...
 /**
    ...
    public function saveServicesSection(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'mvp_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
    ...
    public function savePortfolioSection(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            // HRMS System
            'hrms_icon' => 'required|string|max:255',
            ...
            // CRM System
            'crm_icon' => 'required|string|max:255',
            ...
            // VMS System
            'vms_icon' => 'required|string|max:255',
    ...
    public function saveCtaSection(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            // Buttons
            'primary_btn_icon' => 'required|string|max:255',
            'primary_btn_text' => 'required|string|max:255',
            'primary_btn_link' => 'required|string|max:255',
            'secondary_btn_icon' => 'required|string|max:255',
