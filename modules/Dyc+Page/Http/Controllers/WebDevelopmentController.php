...
class WebDevelopmentController extends Controller
{
    public function index()
    {
        ...
        $pageType = $this->getOrCreatePageType($page->id, 'webdevelopmentpage');
    ...
    public function saveAdditionalServicesSection(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'add_service1_icon' => 'required|string|max:255',
            ...
            'add_service2_icon' => 'required|string|max:255',
            ...
            'add_service3_icon' => 'required|string|max:255',
            ...
            'add_service4_icon' => 'required|string|max:255',
            'is_active' => 'boolean'
        ]);
