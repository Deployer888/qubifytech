        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="sections-sidebar">
                    <div class="p-3 border-bottom">
                        <h5 class="mb-0" style="color: #1e293b; font-weight: 600;">Company Policy</h5>
                    </div>
                    <div class="sections-nav">
                        <button class="section-nav-link active" data-section="terms">
                            <i class="fas fa-star"></i>
                            Terms & Conditions
                        </button>
                        <button class="section-nav-link" data-section="policy">
            ...
            <div class="col-lg-9">
                <div class="content-area">
                    ...
                    <div class="section-content active" id="terms-section">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control editor" name="terms_text" rows="7" placeholder="">{{ isset($termsContent) && $termsContent ? ($termsContent->content_json['text'] ?? '') : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="section-content" id="policy-section">
                        <div class="section-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h2 class="section-title">
                                    <i class="fas fa-users"></i>
...
<script>
    ...
    const forms = [
        { id: 'termsForm', url: '/admin/company-policies/terms-section'},
        { id: 'policyForm', url: '/admin/company-policies/policy-section'}
    ];
