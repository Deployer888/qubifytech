                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cta_button2_link" placeholder="{{ route('frontend.index') }}#contact" value="{{ isset($footerCtaContent) && $footerCtaContent ? ($footerCtaContent->content_json['buttons'][1]['link'] ?? '') : route('frontend.index') . '#contact' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
