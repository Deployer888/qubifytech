                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="image_alt" 
                                            ...
                                            value="{{ isset($webDevContent) && $webDevContent ? ($webDevContent['image_alt'] ?? '') : 'Web Development Services' }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="image" accept="image/*" 
                                            onchange="previewImage(this, 'webDevImagePreview')">
                                    </div>
                                  
                                    @if(isset($webDevContent) && $webDevContent['image_url'])
                                        <div class="mt-2">
                                            <img id="webDevImagePreview" 
                                                src="{{ asset($webDevContent['image_url']) }}" 
                                                alt="{{ $webDevContent['image_alt'] ?? 'Web Development Services' }}" 
                                                class="img-thumbnail" 
                        ...
                        <form id="softwareDevForm">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-2">
                                       ...
                                       <input type="text" class="form-control" name="image_alt" 
                                           ...
                                           value="{{ isset($softwareDevContent) && $softwareDevContent ? ($softwareDevContent['image_alt'] ?? '') : 'Software Development Services' }}">
                                   </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if(isset($softwareDevContent) && $softwareDevContent['image_url'])
                                        <div class="mt-2">
                                            <img id="softwareDevImagePreview" 
                                                src="{{ asset($softwareDevContent['image_url']) }}" 
                                                alt="{{ $softwareDevContent['image_alt'] ?? 'Software Development Services' }}" 
                                                class="img-thumbnail" 
                                                style="max-width: 200px;">
                                        </div>
                                    @else
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-2">
                                        <label class="form-label">Image Alt Text</label>
                                        <input type="text" class="form-control" name="image_alt" 
                                            placeholder="Mobile Development Services" 
                                            value="{{ isset($mobileDevContent) && $mobileDevContent ? ($mobileDevContent['image_alt'] ?? '') : 'Mobile Development Services' }}">
                                    </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Image</label>
                                        <input type="file" class="form-control" name="image" accept="image/*" 
                                            onchange="previewImage(this, 'mobileDevImagePreview')">
                                    </div>

                                    @if(isset($mobileDevContent) && $mobileDevContent['image_url'])
                                        <div class="mt-2">
                                            <img id="mobileDevImagePreview" 
                                                src="{{ asset($mobileDevContent['image_url']) }}" 
                                                alt="{{ $mobileDevContent['image_alt'] ?? 'Mobile Development Services' }}" 
                                                class="img-thumbnail" 
                                                style="max-width: 200px;">
                                        </div>
                                    @else
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">Description</label>
                                        <textarea class="form-control" name="description" rows="4" placeholder="You bring the vision. We craft it to life...">{{ isset($mobileDevContent) && $mobileDevContent ? ($mobileDevContent['description'] ?? '') : 'You bring the vision. We craft it to life—built with precision, passion, and purpose. We build apps that feel natural to use, perform flawlessly, and scale easily with your business growth. From iOS and Android native apps to cross-platform solutions, we deliver mobile experiences that users love.' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group mt-2">
                                        <label class="form-label">Image Alt Text</label>
                                        <input type="text" class="form-control" name="image_alt" 
                                            placeholder="Web Application Development Services" 
                                            value="{{ isset($webAppDevContent) && $webAppDevContent ? ($webAppDevContent['image_alt'] ?? '') : 'Web Application Development Services' }}">
                                    </div>
                                </div>
                               <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Image</label>
                                        <input type="file" class="form-control" name="image" accept="image/*" 
                                            onchange="previewImage(this, 'webAppDevImagePreview')">
                                    </div>

                                    @if(isset($webAppDevContent) && $webAppDevContent['image_url'])
                                        <div class="mt-2">
                                            <img id="webAppDevImagePreview" 
                                                src="{{ asset($webAppDevContent['image_url']) }}" 
                                                alt="{{ $webAppDevContent['image_alt'] ?? 'Web Application Development Services' }}" 
                                                class="img-thumbnail" 
                                                style="max-width: 200px;">
                                        </div>
                                    @else
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function submitServiceForm(form, url, successMessage) {
        ...
        fetch(url, {
            ...
            // Remove the Content-Type header to allow proper file upload
