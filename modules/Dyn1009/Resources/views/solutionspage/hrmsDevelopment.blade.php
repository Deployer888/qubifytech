                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="button2_url" placeholder="{{ route('frontend.index') }}#contact" value="{{ isset($heroContent) && $heroContent ? ($heroContent->content_json['buttons'][1]['url'] ?? '') : route('frontend.index') . '#contact' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Button 2 URL</label>
                                            <input type="text" class="form-control" name="button2_url" placeholder="tel:+917087076111" value="{{ isset($finalCtaContent) && $finalCtaContent ? ($finalCtaContent->content_json['buttons'][1]['url'] ?? '') : 'tel:+917087076111' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
