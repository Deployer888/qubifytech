                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="button1_url" placeholder="#contact" value="{{ isset($heroContent) && $heroContent ? ($heroContent->content_json['buttons'][0]['url'] ?? '') : '#contact' }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="button2_url" placeholder="mailto:sales@qubifytech.com" value="{{ isset($heroContent) && $heroContent ? ($heroContent->content_json['buttons'][1]['url'] ?? '') : 'mailto:sales@qubifytech.com' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="solution{{ $i }}_button_url" placeholder="{{ $defaultSolutions[$i-1]['button_url'] }}" value="{{ isset($solutionsItemsContent) && $solutionsItemsContent ? ($solutionsItemsContent->content_json['solutions'][$i-1]['button_url'] ?? '') : $defaultSolutions[$i-1]['button_url'] }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Button URL</label>
                                            <input type="text" class="form-control" name="cta_button_url" placeholder="mailto:sales@qubifytech.com" value="{{ isset($ctaContent) && $ctaContent ? ($ctaContent->content_json['button_url'] ?? '') : 'mailto:sales@qubifytech.com' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
