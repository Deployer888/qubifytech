                        ...
                        <div class="form-container">
                            <form id="heroForm">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="heroCtaLink" class="form-label">Button Link</label>
                                            <input type="text" class="form-control" id="heroCtaLink" name="hero_cta_link" 
                                                value="{{ $heroContent->content_json['cta']['link'] ?? 'javascript:void(0)' }}" placeholder="Button link">
                                        </div>
                                    </div>
                                </div>
