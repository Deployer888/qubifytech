...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    // Aadhar verification route removed
    // OTP routes removed (were part of Aadhar functionality)
    ...
    Route::get('/web-development/services/', 'FrontendController@webDev')->name('services.web-devvelopment');
    Route::get('/software-development/services/', 'FrontendController@softwareDev')->name('services.software-development');
    Route::get('/web-application-development/services/', 'FrontendController@webApp')->name('services.web-app');
    Route::get('/mobile-application-development/services/', 'FrontendController@mobileApp')->name('services.mobile-app');
    Route::get('/mvp-development/services/', 'FrontendController@mvp')->name('services.mvp-development');
    ...
    // Route::get('/mvp-development/services/', function () {
    //     return view('frontend.services.mvp_dev_service');
